...
ARG NEXT_PUBLIC_HELM_API_URL
ARG NEXT_PUBLIC_USE_HELM_API
...
ENV NEXT_PUBLIC_HELM_API_URL=$NEXT_PUBLIC_HELM_API_URL
ENV NEXT_PUBLIC_USE_HELM_API=$NEXT_PUBLIC_USE_HELM_API
